            ...
            <ContentTemplate>
                <asp:GridView ID="gvData" runat="server" AutoGenerateColumns="false" GridLines="Both" Width="90%" HeaderStyle-BackColor="#ee2748" HeaderStyle-ForeColor="White" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Action Taken" DataField="act" />
                        <asp:BoundField HeaderText="Private IP Addres Y/N" DataField="privateYN" />
                        <asp:BoundField HeaderText="Request URL" DataField="Request" />--%>
                    </Columns>
                </asp:GridView>
                </ContentTemplate>
            </asp:UpdatePanel>
